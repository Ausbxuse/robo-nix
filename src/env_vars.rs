...
const ROBO_MANAGED_ENV_NAMES: &[&str] = &[
    ...
    "UV_CACHE_DIR",
    "ROBO_NIX_PYTHON_EXTRAS",
    "ROBO_NIX_PYTHON_GROUPS",
    "ROBO_NIX_PYTHON_GROUPS_SET",
    "VIRTUAL_ENV",
    "TRITON_LIBCUDA_PATH",
    "CUDA_PATH",
    "CUDA_HOME",
...
pub(crate) const ENV_VARS: &[EnvVarSpec] = &[
    ...
    EnvVarSpec {
        name: "ROBO_NIX_PROFILE",
        visibility: EnvVarVisibility::Internal,
        affects_runtime_key: true,
        description: "Selected runtime profile.",
    },
    EnvVarSpec {
        name: "ROBO_NIX_PROFILE_SELECTOR",
        visibility: EnvVarVisibility::Internal,
        affects_runtime_key: false,
        description: "Requested runtime profile selector for active shell refresh.",
    },
    EnvVarSpec {
    ...
    EnvVarSpec {
        name: "ROBO_NIX_PYTHON_EXTRAS",
        visibility: EnvVarVisibility::Internal,
        affects_runtime_key: true,
        description: "Colon-separated uv extras selected by the runtime profile.",
    },
    EnvVarSpec {
        name: "ROBO_NIX_PYTHON_GROUPS",
        visibility: EnvVarVisibility::Internal,
        affects_runtime_key: true,
        description: "Colon-separated uv dependency groups selected by the runtime profile.",
    },
    EnvVarSpec {
        name: "ROBO_NIX_PYTHON_GROUPS_SET",
        visibility: EnvVarVisibility::Internal,
        affects_runtime_key: true,
        description: "Marks that the runtime profile explicitly selected uv dependency groups.",
    },
    EnvVarSpec {
